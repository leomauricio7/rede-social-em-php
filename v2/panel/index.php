...
<html lang="pt-br">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo Url::getBase(); ?>public/img/logo.png" type="image/x-icon">
  ...
  <body>
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="row">
                <div class="col-3 menu-fixed bg-person">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo Url::getBase() ?>friends"><i class="fas fa-users"></i> Usuários</a>
                        </li>
                        <!--<li class="nav-item">
                            <a class="nav-link" href="<?php echo Url::getBase() ?>chat"><i class="fas fa-comments"></i> Bate-papo</a>
                        </li>-->
